...
class VideoCall extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      // appid: "d22f7adb79f74212acfe69b024d669e9", //Enter the App ID generated from the Agora Website
      appid: props.route?.params?.appId, //Enter the App ID generated from the Agora Website
      // channelName: "xyz", //Channel Name for the current session
      channelName: props.route?.params?.channelName, //Channel Name for the current session
